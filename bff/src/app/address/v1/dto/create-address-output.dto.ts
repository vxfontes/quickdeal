...
export class CreateAddressOutputDto extends PartialType(CreateAddressDto) {}

export class CreateAddressResponseDto extends SuccessRequestResponseDto {
